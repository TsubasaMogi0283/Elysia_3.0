...
GameSceneAudioTest::GameSceneAudioTest(){
	input_ = Input::GetInstance();
}

void GameSceneAudioTest::Initialize() {
...
void GameSceneAudioTest::KeyCollision(){
...
void GameSceneAudioTest::ObjectCollision(){
...
void GameSceneAudioTest::EscapeCondition(){
	//ゲート
...
void GameSceneAudioTest::PlayerMove(){
...
void GameSceneAudioTest::Update(GameManager* gameManager) {
...
void GameSceneAudioTest::DrawSpriteBack(){

}

void GameSceneAudioTest::PreDrawPostEffectFirst(){
	vignette_->PreDraw();
}


void GameSceneAudioTest::DrawObject3D() {
...
void GameSceneAudioTest::DrawPostEffect(){
	vignette_->Draw();
}

void GameSceneAudioTest::DrawSprite(){
